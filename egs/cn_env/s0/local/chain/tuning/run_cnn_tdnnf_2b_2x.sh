...
if [ $stage -le 10 ]; then
  ...
  conv-relu-batchnorm-layer name=cnn2 $cnn_opts height-in=80 height-out=40 height-subsample-out=2 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=128
  conv-relu-batchnorm-layer name=cnn3 $cnn_opts height-in=40 height-out=40 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=128
  conv-relu-batchnorm-layer name=cnn4 $cnn_opts height-in=40 height-out=20 height-subsample-out=2 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=192
  conv-relu-batchnorm-layer name=cnn5 $cnn_opts height-in=20 height-out=20 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=192
  ...
  tdnnf-layer name=tdnnf1 $tdnnf_first_opts dim=2048 bottleneck-dim=512 time-stride=0
  tdnnf-layer name=tdnnf2 $tdnnf_opts dim=2048 bottleneck-dim=256 time-stride=3
  tdnnf-layer name=tdnnf3 $tdnnf_opts dim=2048 bottleneck-dim=256 time-stride=3
  tdnnf-layer name=tdnnf4 $tdnnf_opts dim=2048 bottleneck-dim=256 time-stride=3
